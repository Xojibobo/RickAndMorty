    ...
    useEffect(() => {
        const fetchEpisodeData = async () => {
            ...
            try {
                ...
                const characterPromises = response.data.residents.map(url =>
    ...
    return (
        <div>
            ...
            <div className="header">
                <h1>Location name: <span className="h1-span">{info.name}</span></h1>
                <p >Type: <span className="h1-span">{info.type}</span></p>
            </div>
